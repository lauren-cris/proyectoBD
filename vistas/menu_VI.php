    ...
    function verMenu()
    {
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                <img src="dist/img/DESIGNPINK.jpg" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                <a href="#" class="d-block">DESIGN PINK</a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link" onclick="verModulo('accesos_VI/crud')"><i class="fas fa-key"></i> Accesos</a>
                </li>
                <li class="nav-item">
        ...
        <div class="content-wrapper" id="contenido" style="padding:10px;">
